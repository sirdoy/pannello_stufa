...
- [ ] 167-02-PLAN.md — Rewrite 5 hooks + 4 test files: 63 URL swaps /api/sonos/ -> /api/v1/sonos/ including WS side-fetches and regex matchers
...
| 167. Sonos Frontend Cutover | v19.0 | 1/3 | In Progress|  |
