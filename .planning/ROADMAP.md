...
Plans:
- [x] 21-01-PLAN.md — Slider migration (replace raw input range with design system Slider)
- [x] 21-02-PLAN.md — Scene Button migration (replace raw buttons with Button component)
