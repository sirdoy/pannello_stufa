...
- [x] **Phase 96: Polling Simplification** - Unify all device hooks to 60s useAdaptivePolling, remove Firebase RTDB stove listener and sync-external-state (completed 2026-03-18)
