...
last_updated: "2026-03-30T12:43:57.121Z"
...
| Phase 148-tuya-frontend P02 | 3min | 2 tasks | 4 files |
...
- [Phase 148-02]: TuyaCard uses router.push('/tuya') matching RaspiCard pattern for accessible navigation
- [Phase 148-02]: LastUpdated placed outside data conditional in TuyaCard — renders when tsMs is set (Phase 146 pattern)
