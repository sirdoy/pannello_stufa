# Requirements Archive: v4.0 Advanced UI Components
...
- [x] **CMDK-05**: Palette shows recent commands — **DEFERRED** (user decision: always start fresh)
...
**Shipped:** 55 of 55 v4.0 requirements (100%)
**Deferred:** 1 requirement (CMDK-05 recent commands - user decision)
**Dropped:** None
