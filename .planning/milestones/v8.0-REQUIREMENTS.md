# Requirements Archive: v8.0 Fritz!Box Network Monitor
...
- [x] **INFRA-01**: Server-side proxy API routes for Fritz!Box API with X-API-Key authentication
- [x] **INFRA-02**: Fritz!Box client with rate limiting (10 req/min, 6s minimum delay between requests)
- [x] **INFRA-03**: Firebase RTDB cache for network data with 60s TTL
- [x] **INFRA-04**: Network device type registered in device registry with routes and features
- [x] **INFRA-05**: RFC 9457 error handling with specific error codes (RATE_LIMIT, TIMEOUT, TR064_NOT_ENABLED)
- [x] **INFRA-06**: Fritz!Box connectivity check with setup guide link on TR-064 errors
...
| INFRA-04 | Phase 61 | Complete |
| INFRA-05 | Phase 61 | Complete |
| INFRA-06 | Phase 61 | Complete |
