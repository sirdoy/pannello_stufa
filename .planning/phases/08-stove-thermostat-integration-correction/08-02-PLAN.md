...
- Cleanup removes old entries
  ...
  <done>Debounce service manages in-memory timers with 2-min default delay and early cancellation/retry logic</done>
</task>
...
2. Debounce service uses in-memory Map (no Firebase persistence for timers)
...
- Debounce handles 2-min delay, early cancellation, and 30s retry
