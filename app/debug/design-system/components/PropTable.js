 ...
 * @param {Array<{name: string, type: string, default?: string, description: string, required?: boolean}>} props.props - Array of prop definitions
 ...
 * ]} />
 */
export default function PropTable({ props = [], className = '' }) {
  if (!props.length) {
    return null;
  }
