        ...
        <div className="space-y-4">
          ...
          {status && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {/* Error Code */}
              <Card className={`p-4 ${status.Error !== 0 ? 'bg-ember-500/10 [html:not(.dark)_&]:bg-ember-50 border-2 border-ember-500/30 [html:not(.dark)_&]:border-ember-300' : 'bg-sage-500/10 [html:not(.dark)_&]:bg-sage-50 border-2 border-sage-500/30 [html:not(.dark)_&]:border-sage-300'}`}>
                ...
                {status.Error !== 0 && errorInfo && (
                  <div className="mt-3 pt-3 border-t border-ember-500/30 [html:not(.dark)_&]:border-ember-200">
              ...
              {/* Error Description */}
              <Card className="p-4 bg-slate-800/50 [html:not(.dark)_&]:bg-slate-50 border-2 border-slate-700/50 [html:not(.dark)_&]:border-slate-200">
              ...
              {/* Status Code */}
              <Card className="p-4 bg-ocean-500/10 [html:not(.dark)_&]:bg-ocean-50 border-2 border-ocean-500/30 [html:not(.dark)_&]:border-ocean-200">
              ...
              {/* Status Description */}
              <Card className="p-4 bg-flame-500/10 [html:not(.dark)_&]:bg-flame-50 border-2 border-flame-500/30 [html:not(.dark)_&]:border-flame-200">
                  ...
                  {[1, 2, 3, 4, 5, 6].map(level => (
                    <div
                      ...
                      className={`w-3 h-12 rounded ${
                        level <= fanLevel.Result ? 'bg-ocean-500' : 'bg-slate-700 [html:not(.dark)_&]:bg-slate-200'
                      }`}
                    />
                  ))}
                </div>
                  ...
                  {[1, 2, 3, 4, 5].map(level => (
                    <div
                      ...
                      className={`w-4 h-14 rounded ${
                        level <= powerLevel.Result ? 'bg-flame-500' : 'bg-slate-700 [html:not(.dark)_&]:bg-slate-200'
                      }`}
                    />
                  ))}
                </div>
          ...
          <Card className="p-4 bg-slate-950 [html:not(.dark)_&]:bg-slate-900 border-2 border-slate-700 [html:not(.dark)_&]:border-slate-600">
          ...
          >
            <ul className="space-y-2 ml-4 mt-2">
              <li><Text size="sm" className="text-warning-300 [html:not(.dark)_&]:text-warning-700">• <strong>Polling automatico</strong>: La homepage interroga l&apos;API ogni 5 secondi</Text></li>
              <li><Text size="sm" className="text-warning-300 [html:not(.dark)_&]:text-warning-700">• <strong>Error Code</strong>: Quando diverso da 0, viene mostrato un banner rosso pulsante</Text></li>
              <li><Text size="sm" className="text-warning-300 [html:not(.dark)_&]:text-warning-700">• <strong>Suggerimenti</strong>: Database con 23 codici errore comuni e soluzioni</Text></li>
              <li><Text size="sm" className="text-warning-300 [html:not(.dark)_&]:text-warning-700">• <strong>Logging</strong>: Tutti gli errori vengono salvati su Firebase per storico</Text></li>
              <li><Text size="sm" className="text-warning-300 [html:not(.dark)_&]:text-warning-700">• <strong>Notifiche</strong>: Browser notification per nuovi errori rilevati</Text></li>
            </ul>
            <div className="mt-4 p-3 bg-warning-500/20 [html:not(.dark)_&]:bg-warning-100 rounded-lg">
              <Text size="sm" weight="semibold" className="text-warning-300 [html:not(.dark)_&]:text-warning-700">
                Nota: Se il display della stufa mostra un errore ma l&apos;API riporta Error: 0,
