...
export default function NotificationsSettingsPage() {
  ...
  return (
    <SettingsLayout title="Impostazioni Notifiche" icon="🔔">
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        {device.isPWA && (
                          <span className="px-2 py-0.5 text-xs font-medium bg-success-100 dark:bg-success-900/30 text-success-700 dark:text-success-300 rounded-full">
                            PWA
                          </span>
                        )}
                      </div>
                      ...
                      {device.userAgent && (
                        <p className="text-xs text-neutral-500 dark:text-neutral-500 truncate max-w-md">
                          {device.userAgent}
                        </p>
                      )}
                    </div>
      ...
      {/* Info iOS */}
      <Card liquid className="p-6 bg-info-50/50 dark:bg-info-900/10 border-2 border-info-200 dark:border-info-800">
        <h3 className="text-lg font-semibold text-info-900 dark:text-info-300 mb-3 flex items-center gap-2">
          <span>ℹ️</span>
