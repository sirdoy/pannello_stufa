...
This API exposes real-time and historical data from your home network via a modular REST interface. Each data provider (Fritz!Box, Netatmo, DIRIGERA) is mounted under its own path prefix. All endpoints require authentication.
...
|----------|--------|-------------|
| [FritzBox](./fritzbox.md) | `/api/v1/fritzbox` | Devices, bandwidth, WAN, WiFi, telephony, network services, history |
...
| [DIRIGERA](./dirigera.md) | `/api/v1/dirigera` | IKEA smart home — contact and motion sensors |

See also: [Netatmo Setup Guide](../NETATMO_SETUP.md)

> **Note:** Automation endpoints (`/api/v1/automations`) are scaffolded in the codebase but not yet operational. Full automation support is deferred to v2.4+.
