...
import { filterNotificationByPreferences } from './notificationFilter.js';
...
/**
 * Helper: Get filter message for logging
...
export async function sendNotificationToUser(userId, notification) {
  try {
    ...
    // Apply preference filters (type toggles + DND windows)
