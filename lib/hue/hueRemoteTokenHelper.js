...
export async function getValidRemoteAccessToken(forceRefresh = false) {
  try {
    ...
    console.log('🔍 [Hue Token] Firebase path:', firebasePath);
    console.log('🔍 [Hue Token] NODE_ENV:', process.env.NODE_ENV);
    ...
    if (!forceRefresh) {
      ...
      if (snapshot.exists()) {
        ...
        console.log('🔍 [Hue Token] Firebase data:', {
          has_access_token: !!data.access_token,
          has_refresh_token: !!data.refresh_token,
          access_token_expires_at: firebaseTokenExpires ? new Date(firebaseTokenExpires).toISOString() : null,
