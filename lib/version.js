...
export const VERSION_HISTORY = [
  {
    version: '1.77.0',
    date: '2026-01-25',
    title: 'Stove-Thermostat Sync UI & Auto-Refresh',
    changes: [
      'Nuovo pannello StoveSyncPanel per configurazione interconnessione stufa-termostato',
      'Pulsante "Sincronizza Ora" per sync immediato senza aspettare cronjob',
      'Auto-refresh dati Netatmo dopo sincronizzazione (2s delay per propagazione API)',
      'Fix: import errors in notification routes (apiMiddleware → lib/core)',
      'Fix: import errors in preferences-v2 route (ensureFirebaseAdmin → getAdminFirestore)',
    ],
  },
  {
    version: '1.76.0',
    ...
    changes: [
      'Repository Pattern: astrazione Firebase con BaseRepository',
      'Service Layer: StoveService centralizza business logic',
      'Validators: validazione input riutilizzabile',
      'Routes semplificate: da ~45 a ~20 righe per route',
    ],
  },
  {
    version: '1.73.0',
    date: '2026-01-21',
    title: 'Download video eventi camera',
    changes: [
      'Nuovo pulsante "Scarica video" nella modal eventi camera',
      'Download video HLS in formato .ts (compatibile VLC, QuickTime)',
      'Fix: snapshot fallback quando thumbnail non disponibile',
    ],
  },
  {
    version: '1.72.9',
    date: '2026-01-21',
    title: 'Fix Netatmo valve calibration timeout',
    changes: [
      'Fix: calibrazione valvole chiamava endpoint auth via HTTP causando timeout',
      'Nuovo service netatmoCalibrationService per chiamata diretta server-side',
      'Calibrazione ora avviene ogni 12h invece di 24h',
    ],
  },
  {
    version: '1.72.8',
    date: '2026-01-21',
    title: 'Hue proactive token refresh via cron',
    changes: [
      'Proactive token refresh: il cron refresha automaticamente i token Hue in scadenza',
      'Evita disconnessioni manuali - token rinnovato 24h prima della scadenza',
      'Cleanup: rimossi log di debug verbosi da HueRemoteApi e hueConnectionStrategy',
    ],
  },
  {
    version: '1.72.7',
    date: '2026-01-21',
    title: 'Hue Remote API debug logging',
    changes: [
      'Debug logging per HueRemoteApi: baseUrl, richieste API, gruppi trovati',
      'Aiuta a diagnosticare problemi di connessione Remote API',
    ],
  },
  {
    version: '1.72.6',
    date: '2026-01-21',
    title: 'Hue Remote Pairing & token caching for serverless',
    changes: [
      'Remote Pairing: crea username bridge via cloud (senza rete locale)',
      'Firebase token caching per evitare race condition su Vercel serverless',
      'Auto-retry su 401: HueRemoteApi refresha token e ritenta automaticamente',
      'UI: flusso "Completa Configurazione Cloud" per pairing remoto',
      'Fix: gestione token scaduti e risposta non-JSON da Philips OAuth',
    ],
  },
  {
    version: '1.72.5',
    date: '2026-01-21',
    title: 'Hue Remote API improvements & rooms sorting',
    changes: [
      'Opzione "Connetti via Cloud" quando pairing locale fallisce con timeout',
      'Gestione errore timeout specifica per pairing Hue bridge',
      'Better HTTP error handling nel flusso di connessione Hue',
      'Stanza "Casa" sempre per prima nella lista delle stanze',
      'Sorting stanze applicato a LightsCard, /lights e /lights/scenes',
    ],
  },
  {
    version: '1.72.4',
  ...
  },
  {
    ...
    changes: [
      ...
      'Stufa spenta → solo ACCENDI (prominente)',
      'Stufa accesa → solo SPEGNI',
      'Stato transitorio → entrambi i pulsanti',
    ],
  },
  {
    version: '1.72.0',
    ...
    changes: [
      'HueConnectionStrategy: fallback automatico Local API (CLIP v2) → Remote API (Cloud)',
  ...
  },
  {
    ...
    changes: [
      'Multi-room stove sync: Salotto + Ingresso set to 16°C when stove is ON',
      'Continuous enforcement via scheduler cron (not just state changes)',
      '"🔥 Stufa" badge on ThermostatCard and RoomCard when sync active',
  ...
  },
  {
    ...
    changes: [
      ...
      'Geofencing: Location-based automation (leave home → shutdown, arrive → ignite)',
  ...
  },
  {
    ...
    changes: [
      ...
      'Added battery status indicators (🔋 low, 🪫 critical) to room cards and selector',
      'Added offline status badges (📵) for unreachable devices',
  ...
  },
  {
    ...
    changes: [
      ...
      'Feature: setWaterTemperature(temp) - set water setpoint with 30-80°C validation',
  ...
  },
  {
    ...
    changes: [
      ...
      'Improved: Cleaner credentials resolver (150→105 lines)',
  ...
  },
  {
    ...
    changes: [
      ...
      'Better UX for remote users: no local bridge found → Cloud option',
  ...
  },
  {
    ...
    changes: [
      ...
      'Responsive Buttons: icon-only on mobile (<640px), icon+text on desktop (≥640px)',
  ...
  },
  {
    ...
    type: 'patch',
    changes: [
      'UI Spacing Fix: removed duplicate navbar spacer causing excessive top spacing (144px → 64px on mobile)',
      'Layout Optimization: reduced main padding-top from pt-6 to pt-2 (24px → 8px)',
      'Section Header Spacing: reduced margin-bottom from mb-8 sm:mb-12 to mb-4 sm:mb-8 (32px/48px → 16px/32px)',
  ...
  },
  {
    ...
    changes: [
      ...
      'Settings Redesign: 3-column layout [−] [Level] [+] for improved UX and touch targets',
  ...
  },
  {
    ...
    changes: [
      ...
      'Navigation Spacing: gap-4 between all nav elements (was gap-2 = 8px → 16px = +100%)',
      ...
      'Label Optimization: "Scheduler" → "Orari", "Storico" → "Log" for mobile space saving',
  ...
  },
  {
    ...
    changes: [
      ...
      'Responsive Breakpoints: mobile (< 768px), tablet (768px-1024px), desktop (≥ 1024px) optimized',
  ...
  },
  {
    ...
    changes: [
      ...
      'Modularità Completa: tutti i dettagli spostati in docs/ files, CLAUDE.md solo link e quick reference',
      ...
      'Dependencies Cleanup: rimosso three.js v0.180.0 (non più utilizzato dopo rimozione animazioni WebGL 3D)',
      ...
      'Developer Experience: documentazione più leggibile, navigabile, e manutenibile',
    ],
  },
  {
    version: '1.26.8',
    ...
    changes: [
      ...
      'Toggle Component: componente riutilizzabile con 2 dimensioni (sm/md) e accessibilità ARIA',
  ...
  },
  {
    ...
    changes: [
      ...
      'Gradient Power Dinamico: blu→giallo→arancio→rosso basato su livello (from-blue-400 to-red-600)',
      'Gradient Fan Fisso: cyan→sky→indigo consistente per tutti i livelli ventola',
  ...
  },
  {
    ...
    type: 'patch',
    changes: [
      'Toggle Durata/Ora Fine: aggiunta modalità inserimento con switch tra durata (15min/30min/1h/2h) e ora fine diretta',
      'Edit Mode: AddIntervalModal ora supporta modalità edit per modificare intervalli esistenti',
      ...
      'Preview Live: preview ora mostra "calcolato" o "selezionato" a seconda della modalità',
      'Button Text Dynamic: pulsante conferma cambia da "Aggiungi Intervallo" a "Salva Modifiche" in edit mode',
      'Modal Title Dynamic: titolo cambia da "➕ Aggiungi" a "✏️ Modifica" Intervallo',
  ...
  },
  {
    ...
    changes: [
      ...
      'Risolto bug: modificare intervalli di qualsiasi giorno non resetta più la selezione al primo giorno con intervalli',
  ...
  },
  {
    ...
    type: 'patch',
    changes: [
      'Duplicate Day Feature: implementata funzionalità duplicazione pianificazione su altri giorni',
      ...
      'Toast feedback: notifica successo "Pianificazione duplicata su N giorni" con icona 📋',
  ...
  },
  {
    ...
    changes: [
      ...
      'Weekly Summary Card: statistiche complete (ore totali, media giornaliera, giorno più utilizzato, distribuzione potenza P1-P5, weekday/weekend split)',
      ...
      'Save Status Indicator: "💾 Salvataggio..." → "✓ Salvato" real-time durante edit operazioni con 1s success display',
      'Power/Fan Colored Badges: P1-P5 badges con gradient blu→rosso, V1-V6 badges con cyan→indigo per visual clarity immediata',
      ...
      'UX Flow Optimized: add interval → edit in real-time → confirm delete → toast feedback → remote sync notification',
  ...
  },
  {
    ...
    changes: [
      ...
      'Fluid Typography: clamp-based responsive type scale (fluid-xs → fluid-4xl) per schermi di ogni dimensione',
      ...
      'Reduced Motion Support: @media (prefers-reduced-motion: reduce) per accessibilità utenti sensibili a animazioni',
      'Minimum Touch Targets: button size da 36px a 44px iOS minimum per usabilità mobile migliorata',
      'Card Elevation System: 4 livelli (flat/base/elevated/floating) con shadow progressive per depth perception',
      'Button Variants Consolidation: da 8 a 5 core variants (primary/secondary/success/danger/ghost) per semplicità',
      ...
      'LoadingOverlay Spring: animate-spring-in per entrance animation più moderna e fluida',
      ...
      'Tablet Breakpoint: tb: 900px per transizione fluida mobile → tablet → desktop (1 → 2 → 3 columns)',
  ...
  },
  {
    ...
    changes: [
      ...
      'Select: Animation smoothness improved (150ms → 250ms for dropdown)',
  ...
  },
  {
    ...
    changes: [
      ...
      'Scheduler API Protected (1 route): update (check già protetto con CRON_SECRET)',
      ...
      'Architecture: middleware già proteggeva le pagine, ora anche API routes enterprise-grade secure',
    ],
  },
  {
    version: '1.22.2',
  ...
  },
  {
    ...
    changes: [
      ...
      'UX Migliorata: utente può spegnere e regolare stufa accesa anche quando necessita pulizia',
  ...
  },
  {
    ...
    type: 'minor',
    changes: [
      'Page Transitions: scroll reset automatico su ogni navigazione per UX più pulita',
      ...
      'Zero Breaking Changes: miglioramenti solo visivi, funzionalità esistenti preservate',
    ],
  },
  {
    version: '1.21.1',
  ...
  },
  {
    ...
    changes: [
      ...
      'Deleted Legacy Handler: rimosso app/api/auth/[...auth0]/route.js (non più necessario in v4)',
      'Codebase Coverage: 21 file modificati per compatibilità completa Auth0 v4',
  ...
  },
  {
    ...
    changes: [
      ...
      'Status Refresh Pattern: ogni azione ora: show overlay → command → fetch updated status → hide overlay',
      ...
      'Customizable Messages: LoadingOverlay supporta message e icon props per massima flessibilità',
      'Pulse Effects: animazioni spinner e loading dots per feedback visivo chiaro durante attesa',
      'Zero Breaking Changes: funzionalità esistente preservata, solo aggiunto feedback UX migliorato',
    ],
  },
  {
    version: '1.19.0',
    ...
    changes: [
      ...
      'Bundle Size Optimization: homepage ridotta -1.2 kB (14.6 kB → 13.4 kB) rimuovendo Firebase client imports',
      'Zero Breaking Changes: funzionalità identiche, architettura migliorata, backward compatible',
    ],
  },
  {
    version: '1.18.0',
  ...
  },
  {
    ...
    changes: [
      ...
      'Bug risolto: modalità semi-manuale non si attivava perché campo status (minuscolo) non esiste in API response',
  ...
  },
  {
    ...
    changes: [
      ...
      'ThermostatCard Liquid Glass: disconnected state bg-neutral-100 → liquidPro con ring-1 ring-neutral-200/50',
      'LightsCard Liquid Glass: disconnected state bg-neutral-100 → liquidPro con ring-1 ring-neutral-200/50',
  ...
  },
  {
    ...
    changes: [
      ...
      'Comprehensive Concurrency Tests: 11 nuovi test per verificare atomicità operazioni parallele',
  ...
  },
  {
    ...
    type: 'patch',
    changes: [
      'Visual Inspection E2E Tests: suite completa test Playwright per UI/UX (contrast WCAG AA, uniformità componenti, responsive, dark mode, accessibilità ARIA)',
      ...
      'ThermostatCard dark mode migliorato: background opacity aumentata da 0.03 a 0.08 per migliore visibilità',
  ...
  },
  {
    ...
    changes: [
      ...
      'Priorità env var: variabile d\'ambiente ha priorità su Firebase toggle per automazione test',
      ...
      'Test coverage: aggiunti unit test per verifica funzionalità environment variable',
  ...
  },
  {
    ...
    changes: [
      ...
      'Background Opacity: aumentata da 10% a 15% su button/banner per migliore leggibilità',
      'Ring Borders: rafforzati da 20% a 25% per bordi più definiti',
      'Accessibilità: 100% WCAG AA compliance per testo su tutti i componenti (light e dark mode)',
